...
export function Footer() {
  return (
    <footer className="border-t border-neutral-200 bg-neutral-0 py-16">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-neutral-200 pt-8 sm:flex-row">
          <p className="text-sm text-neutral-500">2024 YULA. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <a
              href="https://twitter.com/yula"
              target="_blank"
